...
class Window(QtWidgets.QWidget):
    ...
    def init_ui(self):
        ...
        ##  LIST OF FONTS
        self.fonts = [ "Times New Roman", "Arial", "Algerian", "Broadway", "Impact", "Magneto", "Pristina", "Vivaldi" ]
    ...
    def btn_click9(self):
        self.myLabel.setStyleSheet("color:" + self.colArray[self.colSwitch] + "; font-family: " + str(self.fonts[random.randint(0,7)]) + "; font-size: " + str(self.fontSize) + "pt; " + "padding: " + str(self.padding) + "px;")
